...
public static class MeshGenerator {
    ...
    public static MeshData GenerateTerrainMesh(float[,] heightMap, MeshSettings meshSettings, int levelOfDetail) {
		...
		MeshData meshData = new MeshData(numVertsPerLine, skipIncrement, meshSettings.useFlatShadding);
		...
		for (int y = 0; y < numVertsPerLine; y++) {
			for (int x = 0; x < numVertsPerLine; x++) {
                ...
                if (!isSkippedVertex) {
                    ...
                    bool isMainVertex = (x - 2) % skipIncrement == 0 && (y - 2) % skipIncrement == 0 && !isOutOfMeshVert && !isMeshEdgeVertex;
...
public class MeshData {
	...
	public MeshData(int numVertsPerLine, int skipIncrement, bool useFlatShadding) {
